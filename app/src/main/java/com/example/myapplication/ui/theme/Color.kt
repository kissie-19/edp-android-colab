...
val SpiderRed = Color(0xFFC62828)
val SpiderBlue = Color(0xFF1565C0)
val SpiderDark = Color(0xFF0D1117)
val SpiderGray = Color(0xFF1E1E1E)
val SpiderGold = Color(0xFFFBC02D)
val SpiderWhite = Color(0xFFFFFFFF)
